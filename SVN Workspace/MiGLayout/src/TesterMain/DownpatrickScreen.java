...
public class DownpatrickScreen extends JFrame {
	
	public DownpatrickScreen(){
		
		JFrame frame = new JFrame();
		frame.setSize(500, 400);
		frame.setVisible(true);
		frame.setDefaultCloseOperation(frame.EXIT_ON_CLOSE);
		frame.setTitle("Downpatrick Printers");
		...
		titleLabel.setText("Downpatric Printers");
