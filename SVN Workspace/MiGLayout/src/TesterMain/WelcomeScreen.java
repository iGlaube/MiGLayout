...
public class WelcomeScreen extends JFrame{
	...
	public WelcomeScreen(){
		...
		panel.add(okButton, "span, sg button, split 2, center");
		okButton.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e){
				...
				frame.setVisible(true);
				System.out.println("Ok button - hit, no selection");
		...
		panel.add(cancelButton, "span, sg button, split 2, center");
		...
		panel.add(stockButton, "span, center ");
